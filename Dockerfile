...
# Links de checkout de Lemon Squeezy: públicos, se inlinean en el cliente.
ARG NEXT_PUBLIC_LS_CHECKOUT_MONTHLY
ARG NEXT_PUBLIC_LS_CHECKOUT_YEARLY
ENV NEXT_PUBLIC_LS_CHECKOUT_MONTHLY=$NEXT_PUBLIC_LS_CHECKOUT_MONTHLY
ENV NEXT_PUBLIC_LS_CHECKOUT_YEARLY=$NEXT_PUBLIC_LS_CHECKOUT_YEARLY
# Paywall de membresías: OFF por defecto. Poné "true" para activarlo (build arg).
ARG NEXT_PUBLIC_MEMBERSHIP_ENABLED
ENV NEXT_PUBLIC_MEMBERSHIP_ENABLED=$NEXT_PUBLIC_MEMBERSHIP_ENABLED
